...
typedef struct fft_mpi_3d_plan
{
    ...
    Complex *inDev, *outDev, *bufferDev1, *bufferDev2, **nodeDataDev, *bufferYZ;
    TransInfo tInfo;
    ...
    // optimized fft
    GPU gpuInfoYZ, gpuInfoX;
    FFTConfiguration configYZ, configX;
    FFTApplication appYZ, appX;
    FFTLaunchParams paramsYZ, paramsX;
